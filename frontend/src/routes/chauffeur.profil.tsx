          ...
          <div className="h-32 bg-gradient-to-r from-[#3BC1A8] via-[#3A9AFF] to-[#3BC1A8] relative">
            ...
            <div className="absolute -bottom-16 right-6 hidden md:block">
              <div className="relative">
                {/* glow effect */}
                <div className="absolute inset-0 rounded-3xl bg-[#3A9AFF]/20 blur-xl"></div>

                <div className="relative flex h-40 w-40 items-center justify-center rounded-3xl bg-gradient-to-br from-[#3BC1A8] to-[#3A9AFF] shadow-xl ring-4 ring-white">
          ...
          <div className="pt-16 pb-8 px-8">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="text-lg text-zinc-600 mt-1">
                  Chauffeur — Ligne 1
                </div>
              </div>
